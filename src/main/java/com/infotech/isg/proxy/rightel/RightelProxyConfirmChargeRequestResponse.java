...
/**
 * representing Rightel ConfirmChargeRequest response object.
 *
 * @author Sevak Gharibian
 */
@XmlRootElement(name = "ConfirmChargeRequestResult")
public class RightelProxyConfirmChargeRequestResponse extends RightelProxyResponse {
